...
LIB_OBJS = layout.o flashrom.o programmer.o helpers.o
...
SVNVERSION := $(shell ./util/getrevision.sh --revision 2>/dev/null )
...
PROGRAMMER_OBJS += sb600spi.o dmi.o pcengines.o
